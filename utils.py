...
br_Hgamgam_sm = 2.3*0.01 #H->yy branching ratio (br) 2.3%
...
def get_width_sf_H_kapp(p_kappabar_c, p_kappabar_ud):
    ...
    width_sf_H = b_quad + 0.215 + 0.063 + 0.026 + 0.0015 + 0.0004 + 0.00022 + \
         ...
         0.0023*width_sf_Hgamgam_kappa(p_kappabar_c, p_kappabar_ud) + \
         b_quad*p_kappabar_c*p_kappabar_c + 2*(b_quad*p_kappabar_ud*p_kappabar_ud)
    return(width_sf_H)


def get_br_Hgamgam_kappa(p_kappabar_c, p_kappabar_ud):
    width_Hgamgam_sm = width_Higgs_sm * br_Hgamgam_sm
    width_Hgamgam = width_Hgamgam_sm * get_width_sf_Hgamgam_kappa(p_kappabar_c, p_kappabar_ud)
    width_H = width_Higgs_sm * get_width_sf_H_kapp(p_kappabar_c, p_kappabar_ud)
    return(width_Hgamgam/width_H)
